...
# Opportunistic-mode dispatcher test (near-call required).
...
api_post "services/input_number/set_value" \
  "{\"entity_id\":\"input_number.hc_disp_${BASE_ZONE}_setpoint_f\",\"value\":${BASE_TARGET_F}}"
api_post "services/input_number/set_value" \
  "{\"entity_id\":\"input_number.hc_disp_${NEAR_ZONE}_setpoint_f\",\"value\":${NEAR_TARGET_F}}"
